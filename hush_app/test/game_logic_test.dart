...
void main() {
  group('Player & Team Calculations Test', () {
    ...
    test('Team total scores aggregate properly across multiple players', () {
      final p1 = Player(id: 'p1', name: 'Ali', teamId: 't1', correctCount: 4, tabooCount: 1);
      final p2 = Player(id: 'p2', name: 'Veli', teamId: 't1', correctCount: 3, tabooCount: 0);
      ...
      expect(team.totalTaboo, 1);
    });

    test('GameStats identifies winning team, MVP, and lowest scorer', () {
      final p1 = Player(id: 'p1', name: 'Star Player', teamId: 't1', correctCount: 10, tabooCount: 0);
      final p2 = Player(id: 'p2', name: 'Average Player', teamId: 't1', correctCount: 2, tabooCount: 1);
      final t1 = Team(id: 't1', name: 'Takım 1', color: Colors.red, players: [p1, p2]);

      final p3 = Player(id: 'p3', name: 'Unlucky Player', teamId: 't2', correctCount: 1, tabooCount: 5);
